...
public class LeftIndexedPowerLawBipartiteGraphSegmentDiffblueTest {
  @Test(timeout=10000)
  public void initializeLeftInternalIdToLongIteratorTest() {
    ...
    // Act and Assert
    assertTrue((new LeftIndexedPowerLawBipartiteGraphSegment(10, 1, 10.0, 10, 3, edgeTypeMask, new NullStatsReceiver()))
