...
public class LeftSalsaIterationDiffblueTest {
  @Test(timeout=10000)
  public void constructorTest() {
    ...
    // Act and Assert
    assertTrue((new LeftSalsaIteration(new SalsaInternalState(bipartiteGraph, new SalsaStats(),
        1))).nodeVisitor instanceof SalsaNodeVisitor.SimpleNodeVisitor);
  }
}
