...
public class TopSecondDegreeByCountUserRecsGeneratorTest {
  @Test
  public void generateUserRecsTest() {
    // Arrange
    ...
    TopSecondDegreeByCountRequestForUser request = new TopSecondDegreeByCountRequestForUser(1L, long2DoubleAVLTreeMap,
        longAVLTreeSet, 1, 1, 1, (java.util.Map<Byte, Integer>) hashMap, new byte[21], 1L, 1L,
    ...
    // Act
    List<RecommendationInfo> actual = TopSecondDegreeByCountUserRecsGenerator.generateUserRecs(request,
