...
public class RightNodeMetadataLeftIndexedPowerLawBipartiteGraphSegmentDiffblueTest {
  @Test(timeout=10000)
  public void initializeLeftInternalIdToLongIteratorTest() {
    ...
    // Act and Assert
    assertTrue((new RightNodeMetadataLeftIndexedPowerLawBipartiteGraphSegment(10, 1, 10.0, 10, 3, 10, edgeTypeMask,
