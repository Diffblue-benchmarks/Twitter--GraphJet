...
public class CosineUpdateNormalizationDiffblueTest {
  ...
  public void computeScoreNormalizationTest() {
    ...
    assertEquals(0.5773502691896258, (new CosineUpdateNormalization()).computeScoreNormalization(10.0, 3, 3), 0.0);
  }

  @Test(timeout=10000)
  public void computeLeftNeighborContributionTest() {
    // Arrange, Act and Assert
    assertEquals(1.0, (new CosineUpdateNormalization()).computeLeftNeighborContribution(1), 0.0);
  }
}
